...
| Q-15 | Ana sayfadaki Vimeo videosunun adresi nedir ve neyi gösteriyor? | Video adresi kayıtlı değil. | PRF-01 | open | |
...
|---|---|---|---|---|---|
| U-01 | Next.js'te birleşik noktalı (U+0307) ve percent-encoded slug'lar birebir eşleşiyor mu? | Faz 1'de her rotayı gerçek istekle test et. | TD-02 | open | |
