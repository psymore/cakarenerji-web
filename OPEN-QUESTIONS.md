...
| Q-06 | Arazi GES Konstrüksiyon ve Solar Carport sayfalarının içeriği nedir? Yoksa sayfalar kaldırılıp yönlendirilsin mi? | Şu an yalnızca başlık var, menü ve footer'da linkler duruyor. | BRK-01, NAV-05 | answered | Canlı sayfalar 2026-09-22'de kullanıcı tarafından kontrol edildi: ikisi de başlık ve fotoğraf galerisi, başka metin yok. Galeriler eklendi. |
...
| U-25 | Canlı sitede ana sayfanın ilk görseli (gün batımı, tepede panel dizisi) hangi dosya? Kayıtlı HTML'de yok; V0 hero'da şimdilik yeşil tarla (`pexels-tom-fisk`) duruyor. | Kendi Chrome'unda görsele sağ tık > Görseli yeni sekmede aç (telefonda uzun bas), adres çubuğundaki URL'yi ver. | VIS-01 | done | Canlı dosya `isteam/getty/2155735205` (sahibin sayfa dökümünden, 2026-09-22); hero artık bunu kullanıyor. |
| U-26 | Arazi GES ve Solar Carport galerileri canlıda nasıl görünüyor ve kaç görsel var? Kayıtlı listede Arazi GES için 9, Carport için 9 dosya var; telefon ekran görüntülerinde Arazi GES'te yaklaşık 6 görsel dönüyordu (bazıları başka ekran boyutuna ait olabilir). Carport'un ekran görüntüsü yok: kaydırıcı mı ızgara mı bilinmiyor. V0 ikisinde de aynı kaydırıcıyı kullanıyor. | Carport sayfasının telefonda ve masaüstünde ekran görüntüsü; ikisinde de kaç görsel dönüyor. | BRK-01 | open | |
