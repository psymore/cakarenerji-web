...
|---|---|---|---|---|---|---|---|
| UIO-01 | Hero light drops to about 48-50 fps without GPU raster (old PCs, VMs, remote desktop, hardware acceleration off). Steady 60 fps with the light removed. | `measurements.md`, software-raster rows | Shrink or drop the 840 px glow, or shrink the 600 px lit window. A transform cannot remove CPU compositing cost. | Yes: visual (look of the light) | U-19 | P2 | out of scope for now (mobile hero light reported as problematic, owner decision 2026-09-21) |
