...
- `components/` UI (`fixes/` = typo gallery): shell (`SiteHeader`, `SiteFooter`, `CookieNotice`), shared (`PageHero`, `Blocks`, `Modules`, `MailForm`, `ContactCard`, `Embeds`, `Countdown`), `home/`, `pages/` (one view per page kind), `blog/`.
